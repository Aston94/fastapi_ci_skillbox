...
async def test_post_create_recipes(client_fixture) -> None:
    ...
    new_recipe_2 = {"dish_title": "гречка",
        "cooking_time": 15,
...
async def test_invalid_recipe_addition(client_fixture) -> None:
    ...
    new_data_1 = {"dish_title": 22,
        "cooking_time": 15,
        "ingredient_list": "вода, гречневая крупа, соль",
        "description": "классика"}

    new_data_2 = {"dish_title": "новое блюдо",
        "cooking_time": 'asd',
        "ingredient_list": "вода, гречневая крупа, соль",
        "description": "классика"}

    new_data_3 = {"dish_title": "новое блюдо",
        "cooking_time": 15,
        "ingredient_list": 22,
        "description": "классика"}

    new_data_4 = {"dish_title": "новое блюдо",
        "cooking_time": 15,
        "ingredient_list": "вода, гречневая крупа, соль",}
...
async def test_adding_an_existing_recipe(client_fixture) -> None:
    ...
    new_data_duplicate = {"dish_title": "гречка",
        "cooking_time": 15,
        "ingredient_list": "вода, гречневая крупа, соль",
        "description": "классика"}
    ...
    assert {"result": "Такой рецепт уже существует в базе."} == json.loads(new_response_2.content.decode())
